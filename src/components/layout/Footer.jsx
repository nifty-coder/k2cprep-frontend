            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/programs#sat-prep" className="hover:text-accent transition-colors">K2C SAT Prep</Link></li>
                            <li><Link to="/programs#math-tutoring" className="hover:text-accent transition-colors">Math Tutoring</Link></li>
                            <li><Link to="/programs#computer-science" className="hover:text-accent transition-colors">Computer Science & Cloud Computing</Link></li>
